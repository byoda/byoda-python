...
TARGET_VIDEO_STREAMS: dict[str, dict[str, str | bool | None]] = {
    ...
    '278': {'resolution': RES_144P,  'streaming_protocol': PROTO_DASH, 'codec': CODEC_VP9,     'tbr': None, 'wanted': False, 'replacement': '',    'category': EncodingCategory.SD},
    ...
    # VP9 — M3U8  (tbr from gist HLS playlist; includes muxed audio)
    '609': {'resolution': RES_720P,  'streaming_protocol': PROTO_HLS, 'codec': CODEC_VP9,       'tbr': 1705, 'wanted': False, 'replacement': '247', 'category': EncodingCategory.SEVENTWENTY},
    '606': {'resolution': RES_480P,  'streaming_protocol': PROTO_HLS, 'codec': CODEC_VP9,       'tbr':  926, 'wanted': False, 'replacement': '244', 'category': EncodingCategory.SD},
    '605': {'resolution': RES_360P,  'streaming_protocol': PROTO_HLS, 'codec': CODEC_VP9,       'tbr':  567, 'wanted': False, 'replacement': '243', 'category': EncodingCategory.SD},
    '604': {'resolution': RES_240P,  'streaming_protocol': PROTO_HLS, 'codec': CODEC_VP9,       'tbr':  289, 'wanted': False, 'replacement': '242', 'category': EncodingCategory.SD},
    '603': {'resolution': RES_144P,  'streaming_protocol': PROTO_HLS, 'codec': CODEC_VP9,       'tbr':  156, 'wanted': False, 'replacement': '278', 'category': EncodingCategory.SD},
    '602': {'resolution': RES_144P,  'streaming_protocol': PROTO_HLS, 'codec': CODEC_VP9_15FPS, 'tbr':   87, 'wanted': False, 'replacement': '598', 'category': EncodingCategory.SD},
    # H.264 — DASH
    ...
    '311': {'resolution': RES_720P,  'streaming_protocol': PROTO_HLS, 'codec': CODEC_H264_HFR, 'tbr': 4842, 'wanted': False, 'replacement': '298', 'category': EncodingCategory.SEVENTWENTY},
    '379': {'resolution': RES_720P,  'streaming_protocol': PROTO_HLS, 'codec': CODEC_H264,     'tbr': None, 'wanted': False, 'replacement': '214', 'category': EncodingCategory.SEVENTWENTY},
    '270': {'resolution': RES_1080P, 'streaming_protocol': PROTO_HLS, 'codec': CODEC_H264,     'tbr': 4694, 'wanted': False, 'replacement': '137', 'category': EncodingCategory.TENEIGHTY},
    '232': {'resolution': RES_720P,  'streaming_protocol': PROTO_HLS, 'codec': CODEC_H264,     'tbr': 2640, 'wanted': False, 'replacement': '136', 'category': EncodingCategory.SEVENTWENTY},
    '231': {'resolution': RES_480P,  'streaming_protocol': PROTO_HLS, 'codec': CODEC_H264,     'tbr': 1358, 'wanted': False, 'replacement': '135', 'category': EncodingCategory.SD},
    '230': {'resolution': RES_360P,  'streaming_protocol': PROTO_HLS, 'codec': CODEC_H264,     'tbr':  812, 'wanted': False, 'replacement': '134', 'category': EncodingCategory.SD},
    '229': {'resolution': RES_240P,  'streaming_protocol': PROTO_HLS, 'codec': CODEC_H264,     'tbr':  327, 'wanted': False, 'replacement': '133', 'category': EncodingCategory.SD},
    '269': {'resolution': RES_144P,  'streaming_protocol': PROTO_HLS, 'codec': CODEC_H264,     'tbr':  175, 'wanted': False, 'replacement': '160', 'category': EncodingCategory.SD},
