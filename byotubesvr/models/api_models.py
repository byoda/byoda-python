...
class PodServiceSettingsRequest(OrmBaseModel):
    pod_username: str
    pod_password: str | None
    youtube_channel: str | None
    youtube_ingest_streams: YouTubeStreamIngestSpec | None
    custom_domain: str | None = None


class PodServiceSettingsResponse(OrmBaseModel):
    account_id: int
    pod_account_id: UUID
...
class ServiceInstanceStatus(OrmBaseModel):
    '''
    A status for a service instance
    '''

    timestamp: datetime
    status_type: InstanceStatusType
    status: ResourceStatus

    # From where did this status originate
    source: str
    resource_name: str
    resource_type: InstanceResourceType
