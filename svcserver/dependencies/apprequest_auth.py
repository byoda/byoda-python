...
class AppRequestAuthOptionalFast(RequestAuth):
    def __init__(self, request: Request,
        ...
        _LOGGER.debug('verifying authentication with an app cert')
    ...
    async def authenticate(self):
        ...
        try:
            _LOGGER.debug('Checking the app cert')
            self.check_app_cert(self.service_id, server.network)
...
AuthDep = Annotated[
    AppRequestAuthOptionalFast, Depends(AppRequestAuthOptionalFast)
]
